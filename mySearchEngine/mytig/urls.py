...
urlpatterns = [
    ...
    path('incrementStock/<int:pk>/<int:number>/',views.RedirectionIncrementStock.as_view()),
    path('decrementStock/<int:pk>/<int:number>/', views.RedirectionDecrementStock.as_view()),
